                    ...
                    {items.map((item, i) => (
                        ...
                        >
                            <div className="flex justify-between items-start gap-4">
                                <span className="text-zinc-400 text-xs lg:text-sm font-bold uppercase tracking-wider mt-1">{item.label}</span>
                                <span className={`font-black text-xl lg:text-2xl whitespace-nowrap text-glow-gold ${item.highlight ? "text-white" : "text-brand-gold"}`}>{item.value}</span>
                            </div>
                            {item.subtext && (
